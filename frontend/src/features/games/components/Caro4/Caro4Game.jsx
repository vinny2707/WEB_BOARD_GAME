...
const CARO4_TUTORIAL_STEPS = [
    {
        ...
        message: "Chỉ cần 4 quân liên tiếp để thắng! Hãy học các bước chơi thông minh.",
        action: "click_next",
        highlightCells: [],
        allowedMoves: [],
    },
    ...
    // BƯỚC 5: Mở rộng tấn công - O tại (2,2), X tại (7,8) → XXXX ngang (Open 4)
    {
        ...
        message: "Quay lại tấn công. Hãy kéo dài chuỗi quân của bạn thành 4 tại (7,8)!",
        action: "click_cell",
    ...
    // Hiển thị chiến thắng - 5 quân liên tiếp
    {
        id: 8,
        title: "Chiến thắng! 🎉",
        message: "Xuất sắc! 5 X liên tiếp theo hàng ngang (7,8) → (11,8)! Bạn đã học được cách tấn công, phòng thủ và chiến thắng!",
        action: "click_next",
    ...
    // Hoàn thành
    {
        id: 9,
        title: "Hoàn thành! 🚀",
        message: "Bạn đã học: 1) Chiếm trung tâm. 2) Tạo liên kết. 3) Tấn công nối dài. 4) Nhận biết nguy hiểm & chặn. 5) Mở rộng tấn công. 6) Kết liễu chiến thắng!",
        action: "finish",
        highlightCells: [],
        allowedMoves: [],
    }
